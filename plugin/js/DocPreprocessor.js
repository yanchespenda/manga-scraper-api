...
const convertValueToString = value => {
  ...
  } else if ((0, _variableType.isNumber)(value) || (0, _variableType.isBoolean)(value)) {
...
class DocPreprocessor {
  ...
  preprocessNode(node) {
    ...
    if ((0, _variableType.isArray)(node)) {
      node = {
        stack: node
      };
    } else if ((0, _variableType.isString)(node) || (0, _variableType.isNumber)(node) || (0, _variableType.isBoolean)(node) || !(0, _variableType.isValue)(node) || (0, _variableType.isEmptyObject)(node)) {
  ...
  preprocessText(node) {
    if (node.tocItem) {
      if (!(0, _variableType.isArray)(node.tocItem)) {
    ...
    } else if ((0, _variableType.isArray)(node.text)) {
